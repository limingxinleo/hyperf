...
- [#7808](https://github.com/hyperf/hyperf/pull/7808) 優化 AMQP 消費者：當 `concurrent.limit` 小於 `qos.prefetch_count` 時，記錄錯誤日誌並自動擴大 `concurrent.limit`，避免觸發 `AMQPInvalidFrameException` 異常。
